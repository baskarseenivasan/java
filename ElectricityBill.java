...
public class ElectricityBill {
	public static void main(String[] args) {
		...
		System.out.println("Enter the Occupation such as Farmer, Handloom, others");
		...
		if(occupation2.equals(occupation))
			if(unit<=200)
		{
			System.out.println("your unit is free");
		}
		...
		{
			System.out.println("please check your entered occupation");
		}
